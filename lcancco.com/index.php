...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Frontend developer, here you will find information about the projects I have done."
    />
    <meta
      property="og:description"
      content="Frontend developer, here you will find information about the projects I have done. "
    />
    <meta property="og:title" content="Jose Estrada | Frontend Developer" />
    <meta property="og:type" content="website" />
    <meta
      property="og:site_name"
      content="Jose Estrada | Frontend Developer"
    />
    ...
    <title>Leonardo Condori / Frontend Developer</title>
  </head>
  <body>
    <nav class="navbar">
      <div class="container">
    ...
    <section id="home" class="home">
      ...
      <picture>
        <source type="image/webp" srcset="./assets/profile.webp" />
        <source type="image/jpeg" srcset="./assets/profile.jpg" />
        <img class="home__profile" alt="picture profile" />
      </picture>
      <div class="home__description">
        <span class="home__title--primary">Hi!</span>
        <h1 class="home__title">I'm Leonardo Condori</h1>
      ...
      <div class="container">
        ...
        <div class="about__grid">
          <div class="about__description">
            <h2>Who am I?</h2>
            <h2>I'm Leonardo Condori, Web Developer</h2>
            <p>
            ...
            <a
              class="button--cta"
              href="./assets/Leonardo Condori CV.pdf"
              download="Leonardo Condori CV"
              target="_blank"
          ...
          <div class="about__skills">
            ...
            <div class="skill__item">
              ...
              <div class="skill__name">ANGULAR</div>
            </div>
      ...
      <div class="container">
        ...
        <div class="portfolio__grid">
          <div class="portfolio__item">
            <picture>
              <source type="image/jpeg" srcset="./projects/iniaagro.jfif" />
              <img class="portfolio__img" alt="portfolio item" />
            </picture>
            <div class="portfolio__description">
              <h3 class="portfolio__description--title">Inia Agro</h3>
              <p class="portfolio__description--text">
                Web Application: Java, Angular, Oracle
              </p>
          ...
          <div class="portfolio__item">
            <picture>
              <source type="image/jpeg" srcset="./projects/cajacusco.jfif" />
              <img class="portfolio__img" alt="portfolio item" />
            </picture>
            <div class="portfolio__description">
              <h3 class="portfolio__description--title">Caja Cusco</h3>
              <p class="portfolio__description--text">
                Web Application: HTML, CSS, JS, Angular, Java
              </p>
              <div class="buttons__container">
                <!-- <a
                  class="button"
          ...
          <div class="portfolio__item">
            <picture>
              <source type="image/jpeg" srcset="./projects/sedalibindicadores.png" />
              <img class="portfolio__img" alt="portfolio item" />
            </picture>
            <div class="portfolio__description">
              <h3 class="portfolio__description--title">Sedalib Indicadores</h3>
              <p class="portfolio__description--text">
                Web Application: Angular, Java
              </p>
              <div class="buttons__container">
               <!--  <a
                  class="button"
          ...
          <div class="portfolio__item">
            <picture>
              <source type="image/jpeg" srcset="./projects/sedalibalertas.png" />
              <img class="portfolio__img" alt="portfolio item" />
            </picture>
            <div class="portfolio__description">
              <h3 class="portfolio__description--title">Sedalib Alertas</h3>
              <p class="portfolio__description--text">
                Web applications: Angular, Java, Oracle 
              </p>
              <div class="buttons__container">
               <!--  <a
                  class="button"
          ...
          <div class="portfolio__item">
            <picture>
              <source type="image/jpeg" srcset="./projects/llamagas.png" />
              <img class="portfolio__img" alt="portfolio item" />
            </picture>
            <div class="portfolio__description">
              <h3 class="portfolio__description--title">Llamagas Call Center</h3>
              <p class="portfolio__description--text">Web Application: Angular, Java</p>
              <div class="buttons__container">
               <!--  <a
                  class="button"
          ...
          <div class="portfolio__item">
            <picture>
              <source type="image/jpeg" srcset="./projects/veterinariamascotas.png" />
              <img class="portfolio__img" alt="portfolio item" />
            </picture>
            <div class="portfolio__description">
              <h3 class="portfolio__description--title">Veterinaria Mascotas</h3>
              <p class="portfolio__description--text">
                Web page, Ecomerce: HTML, CSS,JAVASCRIPT, JAVA JSP
              </p>
              <div class="buttons__container">
               <!--  <a
                  class="button"
    ...
    <section id="contact">
      <div class="container">
        ...
        <div class="contact__grid">
          ...
          <a
            href="mailto:condorianccoleo@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://github.com/TortugaDio"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="contact__item">
          ...
          <a
            href="https://twitter.com/LCAncco"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="contact__item">
          ...
          <a
            href="https://www.linkedin.com/in/leonardo-condori-ancco-aa22b9182/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="contact__item">
    ...
    <footer class="footer">
      <div class="container">
        <p>
          Copyright © 2021. <a href="#">@LCAncco</a> <br />
          All Rights Reserved
        </p>
      </div>
    </footer>
